...
class SyncManagerTests(unittest.TestCase):
    ...
    def test_retrieve_refresh_throttles_recent_failed_attempt_and_uses_short_fetch_timeout(self):
        ...
        git.assert_called_once_with("fetch", timeout_seconds=RETRIEVE_SYNC_FETCH_TIMEOUT_SECONDS)
    ...
    def test_deferred_sync_policy_and_scheduler(self):
        ...
        with (
            ...
            patch("rightmemory.sync.detached_process_kwargs", return_value={"start_new_session": True}),
        ...
        self.assertEqual(Path(kwargs["stdout"].name), self.device / ".runtime" / "sync" / "deferred.log")
