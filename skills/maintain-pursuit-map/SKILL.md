...
- A precise requested edit is already authorized. For broad cleanup or ambiguous reorganization, present the proposed tree change concisely and wait for approval. An inspection request alone does not authorize changes.
