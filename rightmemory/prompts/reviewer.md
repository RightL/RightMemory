...
M# headings. Record who or what the shared view represents, when this root
should use it, and how it relates to nearby work. From the transcript alone,
do not absorb provider content. Preserve local decisions, commitments, tasks, or
consequences, and keep external provenance when shared-view material is
explicitly absorbed.
