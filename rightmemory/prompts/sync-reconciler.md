...
- The source of truth is the memory file set: `MEMORY.md`, sibling `MEMORY_*.md` files, `dream_logs/*.md`, and supplied skill artifacts when they are part of the sync repair.
