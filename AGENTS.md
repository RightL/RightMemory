...
- Correction entries should be concrete: name the file, quote or summarize the wrong wording, show the corrected wording or shape, and state the reason. The goal is to preserve the user's correction well enough that future agents do not repeat the same mistake.
